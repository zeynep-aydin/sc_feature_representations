...
# sbatch --array=1 --export=ALL,LEVEL=broad,HVG_ONLY=1 --job-name=tabula_broad_pca_hvg slurm_scripts/classify_tabula_sapiens.sh pca  # no-HVG pca already done
...
# sbatch --array=1 --export=ALL,LEVEL=compartment,HVG_ONLY=1 --job-name=tabula_compartment_pca_hvg slurm_scripts/classify_tabula_sapiens.sh pca  # no-HVG pca already done
...
# sbatch --array=1 --export=ALL,LEVEL=fine,HVG_ONLY=1 --job-name=tabula_fine_pca_hvg slurm_scripts/classify_tabula_sapiens.sh pca  # no-HVG pca already done
